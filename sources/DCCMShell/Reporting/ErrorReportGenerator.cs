...
A Fatal Error / Unhandled Exception has occurred and the game has crashed. (Simple) (Buildt-in reporter)
...
""";
        ...
        {
            Console.Error.WriteLine(ERROR_REPORT_HEADER);
            Console.Error.WriteLine($"Please check the log file for more detailed information: {ERROR_REPORT_PATH}");
