...
namespace ModCore.Native
{
    public unsafe partial class TCCCompiler : IDisposable
    {
        ...
        [LibraryImport(LIBTCC)]
        private static partial void tcc_set_lib_path( nint s, byte* path );
        ...
        [LibraryImport(LIBTCC)]
        private static partial int tcc_set_options( nint s, byte* str );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_add_file(nint s, byte* str );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_add_include_path( nint s, byte* str );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_add_sysinclude_path( nint s, byte* str );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_compile_string(nint s, byte* str );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_add_library_path(nint s, byte* str );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_set_output_type( nint s, int output_tyoe );
        [LibraryImport(LIBTCC)]
        private static partial int tcc_output_file(nint s, byte* filepath );
        ...
        public int AddString( string str )
        {
            ...
            return tcc_compile_string(tcc_state, (byte*)Marshal.StringToCoTaskMemUTF8(str));
        }
        ...
        public int AddOptions( string options )
        {
            ...
            return tcc_set_options(tcc_state, (byte*)Marshal.StringToCoTaskMemUTF8(options));
        }
        ...
        private byte* GetPathPtr( string path )
        {
            return (byte*) Marshal.StringToCoTaskMemUTF8(path.Replace('\\', '/'));
        }
